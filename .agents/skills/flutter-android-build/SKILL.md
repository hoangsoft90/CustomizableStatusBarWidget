...
> Covers version compatibility, config templates, common error patterns with fixes,
> and a ready-to-use GitHub Actions workflow.

---

## 1. The Golden Version Matrix (2025-2026)
...
android {
    ...
    buildTypes {
        release {
            ...
            // ⚠️ CRITICAL: R8 MUST be disabled for Flutter
...
**Fix:** AGP→Gradle minimum versions:
- AGP 8.0–8.4 → Gradle 8.0–8.6
- AGP 8.5–8.7 → Gradle 8.7–8.10
- AGP 9.0–9.1 → Gradle 8.9–9.4
- AGP 9.2 → Gradle 9.2+
- AGP 9.3 → Gradle 9.5+
