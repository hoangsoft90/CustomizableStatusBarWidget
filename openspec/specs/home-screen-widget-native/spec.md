...
`DateTimeWidgetProvider` extends `AppWidgetProvider` to render day/date/time on the home screen. Supports 4 widget sizes (2×1, 3×1, 4×1, 4×2) with separate layout XML files. Config is read from "status_bar_config" SharedPreferences.
